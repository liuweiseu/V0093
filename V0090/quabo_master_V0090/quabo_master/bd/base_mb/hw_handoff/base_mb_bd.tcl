...
# module references:
# IBUFDS_FOR_CLK, OBUFDS_FOR_CLK, PPS_IO, SPI_MUX, SPI_STARTUP, SPI_access, delay, elapsed_time_gen, flash_control, in_buf_ds_1bit, in_buf_ds_4bit, in_buf_ds_1bit, stepper_control, stim_gen
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net PPS_IO_0_pps_inside_out [get_bd_pins PPS_IO_0/pps_inside_out] [get_bd_pins delay_0/din] [get_bd_pins elapsed_time_gen_0/one_pps]
  ...
  connect_bd_net -net clk_wiz_0_clk_320 [get_bd_pins clk_wiz_0/clk_250] [get_bd_pins delay_0/clk] [get_bd_pins flash_control_0/hs_clk]
  ...
  connect_bd_net -net delay_0_dout [get_bd_pins delay_0/dout] [get_bd_pins flash_control_0/one_pps]
  ...
  connect_bd_net -net wrc_board_quabo_Light_0_pps_o1 [get_bd_ports SMA_J1] [get_bd_pins PPS_IO_0/pps_inside_in] [get_bd_pins wrc_board_quabo_Light_0/pps_o]
  ...
  connect_bd_net -net xlslice_0_Dout1 [get_bd_pins PPS_IO_0/io_ctrl0] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins Bit_1_1/Dout] [get_bd_pins stim_gen_0/enable]
  connect_bd_net -net xlslice_1_Dout1 [get_bd_pins PPS_IO_0/io_ctrl1] [get_bd_pins xlslice_1/Dout]
